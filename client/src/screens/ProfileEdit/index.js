...
const ProfileEdit = () => {
  ...
  useEffect(() => {
    const originalUrl = `https://buy-staging.moonpay.com?apiKey=${process.env.REACT_APP_MOONPAY_PUBLISHABLE_KEY}&currencyCode=fusd&walletAddress=${user?.addr}&redirectURL=https%3A%2F%2Fwww.nfluence.fans%2F`
